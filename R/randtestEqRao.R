# Permutation test for the third type of diversity decomposition
#' @title Permutation test for the third type of diversity decomposition (\code{\link{EqRao}}).
#'
...
#' @param formula Quadratic entropy formula ("QE", "EDI"). "QE" is default.a 
...
#' @seealso \code{\link{EqRao}}, \code{\link{randtest}}.
#'
#' @examples
#' data(macroloire)
...
randtestEqRao <- function(df, dis = NULL, structures = NULL, formula = c("QE", "EDI"), 
                          option = c("normed1", "normed2", "eq"), wopt = c("even", "speciesab"), level = 1, 
                          nrep = 99, alter = c("greater", "less", "two-sided"), tol = 0.00000001,
